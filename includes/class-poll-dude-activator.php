...
class Poll_Dude_Activator {
	...
	private static function activation() {
		...
		'<div id="polls-%POLL_ID%-ans" class="wp-polls-ans">'.
		'<ul class="wp-polls-ul">');
		add_option('poll_template_resultbody', '<li>%POLL_ANSWER% <small>(%POLL_ANSWER_PERCENTAGE%%'.__(',', 'poll-dude-domain').' %POLL_ANSWER_VOTES% '.__('Votes', 'poll-dude-domain').')</small><div class="pollbar" style="width: %POLL_ANSWER_IMAGEWIDTH%%;" title="%POLL_ANSWER_TEXT% (%POLL_ANSWER_PERCENTAGE%% | %POLL_ANSWER_VOTES% '.__('Votes', 'poll-dude-domain').')"></div></li>');
		add_option('poll_template_resultbody2', '<li><strong><i>%POLL_ANSWER% <small>(%POLL_ANSWER_PERCENTAGE%%'.__(',', 'poll-dude-domain').' %POLL_ANSWER_VOTES% '.__('Votes', 'poll-dude-domain').')</small></i></strong><div class="pollbar" style="width: %POLL_ANSWER_IMAGEWIDTH%%;" title="'.__('You Have Voted For This Choice', 'poll-dude-domain').' - %POLL_ANSWER_TEXT% (%POLL_ANSWER_PERCENTAGE%% | %POLL_ANSWER_VOTES% '.__('Votes', 'poll-dude-domain').')"></div></li>');
